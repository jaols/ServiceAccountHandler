...
REM PowerShell -Command "%~dp0%MyName:~3%.ps1" %* >> %StdLog% 2>> %ErrLog%

REM This line will launch with an ERROR-log ONLY (logging is up to the PS file)
PowerShell -Command "%~dp0%MyName:~3%.ps1" %* 2>> %ErrLog%
